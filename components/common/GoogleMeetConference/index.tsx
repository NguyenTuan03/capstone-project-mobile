...
const GoogleMeetConference: React.FC<GoogleMeetConferenceProps> = ({
    ...
    const openMeetInBrowser = useCallback(async () => {
        try {
            console.log("[GoogleMeetConference] Opening Meet in browser:", meetLink);
            const result = await WebBrowser.openBrowserAsync(meetLink);
            console.log("[GoogleMeetConference] Browser result:", result);
            ...
            console.error("[GoogleMeetConference] Error opening browser:", error);
    ...
    React.useEffect(() => {
        if (isVisible) {
            console.log("[GoogleMeetConference] Modal opened with link:", meetLink);
            openMeetInBrowser();
        }
