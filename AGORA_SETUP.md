...
When a coach opens a session and clicks "Tham gia lớp học trực tuyến" (Join Video Class):
...
| End Call Button | Leave channel and close modal | 📞 (Red) |
...
```typescript
// Connection errors
Alert.alert("Lỗi kết nối", "Không thể kết nối tới lớp học trực tuyến")
...
2. Click "Tham gia lớp học trực tuyến" button
3. Wait for "Đang kết nối..." loading screen
...
⚠️ **Never commit Agora App ID to version control**
